    ...
    >
      {items.map((item, index) => (
        <Badge
          key={index}
          variant="secondary"
          className="px-3 py-1 text-sm font-medium bg-gray-700 text-gray-200 border border-gray-600 hover:bg-gray-600 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800"
          tabIndex={0}
          role="listitem"
        >
          {item}
...
export const AboutSection: React.FC<AboutSectionProps> = () => {
  return (
    <section
      className="container mx-auto py-16 px-6 md:px-12 lg:px-16 animate-fade-in-up text-gray-300"
      aria-labelledby="about-title"
      aria-describedby="about-details"
    >
      <h2
        id="about-title"
        className="text-4xl font-extrabold text-white mb-8 text-center leading-tight tracking-tighter"
      >
        About Me
      </h2>

      <p className="mb-8 text-lg text-gray-400 text-center max-w-3xl mx-auto leading-relaxed">
      ...
      <div
        className="grid grid-cols-1 md:grid-cols-2 gap-12 animate-fade-in-down"
